...
if __name__ == "__main__":
    stereo_system = StereoVision()
    left_camera_box = (480, 200, 40, 0.5)
    right_camera_box = (160, 200, 40, 0.5)

    distance, angle = stereo_system.analyze(left_camera_box, right_camera_box)
    print(f"Test: Distance = {distance:.2f} inches, Angle = {angle:.2f} degrees")