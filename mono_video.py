...
fov_horizontal = 63.3    # in degrees
...
if __name__ == "__main__":
    ...
    distance = camera.calculate_distance(object_width)
    angle_offset = camera.calculate_angular_offset(object_x)

    print(f"Distance to object: {distance:.2f} inches")
    print(f"Angular offset from center: {angle_offset:.2f} degrees")
